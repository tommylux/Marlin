/**
 * Tom Luxton
 * This File represents me copying values from Verts into the vanilla style config.h
 * 
...
#define STRING_CONFIG_H_AUTHOR "Tom Luxton" // Who made the changes.
...
#define MACHINE_UUID "99930527-5a00-4278-8c25-7c098addc322"

// @section extruder

// This defines the number of extruders
// :[0, 1, 2, 3, 4, 5, 6, 7, 8]
//Tom Needs to be set to 1
#define EXTRUDERS 1
...
//Tom Should this be enabled to prevent temp drops?
//#define SINGLENOZZLE
 ...
 */
#define TEMP_SENSOR_0 1 //Tom this shows as 5 on Verts conf
...
//Tom Verts example doesn't seem to define these.
...
//Tom different to Sample config
 ...
 */
//Tom This is not defined in Verts example
 ...
 */
//Tom does not appear to be in Verts example
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN

// Force the use of the probe for Z-axis homing
//Tom not sure if this could be enabled, disabled in Verts and Sample.
...
// Tom Probing_Margin different in sample and Verts, have used 30 to try and avoid bed clips.
#define PROBING_MARGIN 30
/***
* Tom Other items defined in Verts but not in sample, might be worth investigating if probing off bed.
...
//Tom absolute values in verts.. 8*60
 ...
 */
//Tom Various configs slightly different  to verts. Matched Sample
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT3_PIN     54          //TL apparently 54 not 68 according to Bruce.
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  //Tom Various settings different in Verts. Updated to Sample
  ...
  //Tom Number of points to adjust?
...
//Tom Adjust Level corners if reqd?
  ...
  //Tom Enabled assumed preference.. Disabled in sample config, enabled in Verts
  #define LEVEL_CENTER_TOO              // Move to the center after the last corner 
  
  //Tom Consider turning on may impact location of probing. Not enabled in either sample or Verts
...
//#define SKEW_CORRECTION
  ...
  //Tom enabled in verts, assumed not required matched sample.
...
//Tom different to Verts slightly.
...
//Tom enabled for user preference
